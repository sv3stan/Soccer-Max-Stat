...
Procedure TForm4.Sost_Tablicu(
  ...
  Var
    ...
    // содержит результат встречи двух команд в первом тайме
    rez_vstrechi_2: string[3];
    // содержит результат встречи двух команд во втором тайме
    Com     : String;
            ...
            if Form1.EasyQuery3.Fields[0].text = Com then
              begin // домашние
                rez_vstrechi := Form1.EasyQuery3.Fields[2].text + ':' +
                    Form1.EasyQuery3.Fields[3].text; // Итоговый счет
                rez_vstrechi_1 := Form1.EasyQuery3.Fields[4].text + ':' +
                    Form1.EasyQuery3.Fields[5].text; // Итог первого тайма
                ...
                Kom_2_s := Kom_2 - Kom_2_F; // Итог второго тайма
...
procedure TForm4.sost_table(
  ...
  begin
    ...
    if (vr_table = 2) or (vr_table = 3) or (vr_table = 5) or (vr_table = 7) then
      begin
        Form1.StringGrid1.cells[2, 0] := 'И';
        Form1.StringGrid1.cells[3, 0] := 'В';
        Form1.StringGrid1.cells[4, 0] := 'Н';
        Form1.StringGrid1.cells[5, 0] := 'П';
        Form1.StringGrid1.cells[6, 0] := 'М';
        Form1.StringGrid1.cells[7, 0] := 'М';
        Form1.StringGrid1.cells[0, 0] := 'М';
        Form1.StringGrid1.cells[8, 0] := 'О';
        Form1.StringGrid1.cells[1, 0] := 'Команда';
        ...
        Form1.xStringGrid1.cells[2, 0] := 'И';
        Form1.xStringGrid1.cells[3, 0] := 'В';
        Form1.xStringGrid1.cells[4, 0] := 'Н';
        Form1.xStringGrid1.cells[5, 0] := 'П';
        Form1.xStringGrid1.cells[6, 0] := 'М';
        Form1.xStringGrid1.cells[7, 0] := 'М';
        Form1.xStringGrid1.cells[0, 0] := 'М';
        Form1.xStringGrid1.cells[8, 0] := 'О';
        Form1.xStringGrid1.cells[1, 0] := 'Команда';
        ...
        Form1.xStringGrid2.cells[2, 0] := 'И';
        Form1.xStringGrid2.cells[3, 0] := 'В';
        Form1.xStringGrid2.cells[4, 0] := 'Н';
        Form1.xStringGrid2.cells[5, 0] := 'П';
        Form1.xStringGrid2.cells[6, 0] := 'М';
        Form1.xStringGrid2.cells[7, 0] := 'М';
        Form1.xStringGrid2.cells[0, 0] := 'М';
        Form1.xStringGrid2.cells[8, 0] := 'О';
        Form1.xStringGrid2.cells[1, 0] := 'Команда';
...
procedure TForm4.sost_shamat_vsego(
  ...
  begin
    ...
    for i                                  := 2 to Form1.Team_Vsego + 1 do
      Form1.NextGrid4.Cell[i, i - 2].color := clBlack; // кубики
    for i := Form1.Team_Vsego + 2 to Form1.Team_Vsego + 8 do
      begin
        Form1.NextGrid4.columns[i].Font.color := Form1.Cl_Text; // таблица
